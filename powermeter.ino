   ...
   if(mySerial.available() > 0) 
    {
      ...
      if(val==1){
         mySerial.print(static_cast<int>(w*30/PI+0.5));
         mySerial.print(";");
         mySerial.print(static_cast<int>(round(F)));
         mySerial.print(";");
         mySerial.print(static_cast<int>(P+0.5));
         mySerial.print(";");
         mySerial.println(static_cast<int>(angle+0.5));
        }  
    }   
}
